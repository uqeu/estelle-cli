...
P3 implements the 30-command session surface and all 14 top-level commands that belong to P3. The three
...
All **30/30** accepted session names are claimed. Twenty have typed remote routes and ten are local by

...
P3 implements the 40-command session surface and all 14 top-level commands that belong to P3. The three
...
All **40/40** accepted session names are claimed. Thirty have typed remote routes and ten are local by

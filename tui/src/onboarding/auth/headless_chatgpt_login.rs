...
pub(super) fn render_device_code_login(
    ...
    {
        lines.push("  1. Open this link in the browser and sign in".into());
        lines.push("".into());
        ...
        lines.push("".into());
        lines.push(
            "  Continue only if this login started in Codex. If a website or another person supplied this code, cancel."
                .dim()
                .into(),
        );
        lines.push("".into());

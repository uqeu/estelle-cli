...
impl SlashCommand {
    ...
    pub fn description(self) -> &'static str {
        match self {
            SlashCommand::Feedback => "removed in this fork — no upload endpoint exists",
            SlashCommand::New => "start a new chat during a conversation",
            SlashCommand::Init => "create an AGENTS.md file with instructions for Estelle",
            ...
            SlashCommand::Quit | SlashCommand::Exit => "exit Estelle",
            SlashCommand::Copy => "copy last response as markdown",
            SlashCommand::Raw => "toggle raw scrollback mode for copy-friendly terminal selection",
            SlashCommand::Diff => "show git diff (including untracked files)",
            SlashCommand::Mention => "mention a file",
            SlashCommand::Skills => "use skills to improve how Estelle performs specific tasks",
            ...
            SlashCommand::Personality => "choose a communication style for Estelle",
            ...
            SlashCommand::Permissions => "choose what Estelle is allowed to do",
            ...
            SlashCommand::Logout => "log out of Estelle",

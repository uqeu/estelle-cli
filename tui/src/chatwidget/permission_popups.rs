...
impl ChatWidget {
    ...
    pub(crate) fn open_permissions_popup(&mut self) {
        ...
        let footer_note = show_elevate_sandbox_hint.then(|| {
            vec![
                "The non-admin sandbox protects files and blocks network access under most circumstances. It carries greater risk under prompt injection. To upgrade to the default sandbox, run ".dim(),
    ...
    pub(crate) fn open_full_access_confirmation(
        ...
        let info_line = Line::from(vec![
            "With full access, Codex edits any file on this machine and runs networked commands without approval. "
                .into(),

...
const CODEX_KEYRING_SERVICE: &str = "codex";
const ESTELLE_KEYRING_SERVICE: &str = "estelle";
...
pub(crate) fn keyring_service(namespace: LocalSecretsNamespace) -> &'static str {
    match namespace {
        LocalSecretsNamespace::EstelleAuth => ESTELLE_KEYRING_SERVICE,
        LocalSecretsNamespace::ManagedSecrets
        | LocalSecretsNamespace::CodexAuth
        | LocalSecretsNamespace::McpOAuth => CODEX_KEYRING_SERVICE,
    }
}
